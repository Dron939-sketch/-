...
VECTORS = [
    {"code": "CO", "name": "Соответствие", "color": "#5EA8FF",
     "what":  "Голос совпадает с архетипом — устойчивая узнаваемость."},
    {"code": "RE", "name": "Регулярность", "color": "#FFD89B",
     "what":  "Постоянство присутствия в ленте."},
    {"code": "EN", "name": "Вовлечение",   "color": "#B0F0C0",
     "what":  "Реакция аудитории — лайки/просмотры/комменты."},
    {"code": "RP", "name": "Отзывчивость", "color": "#FF9F4A",
     "what":  "Скорость и доля ответов на обращения."},
]
