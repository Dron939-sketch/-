...
def _build_recommendations(
    ...
    strategy.append({
        "icon":  "🌐",
        "what":  "Разместить биографию на 2-3 порталах кроме VK",
        "why":   "Когда избиратель гуглит твоё имя — должна быть полная страница выдачи. "
                 "Старт: lichnosty.ru, peoples.ru, wikipedia (если есть упоминания в СМИ)."
    })
