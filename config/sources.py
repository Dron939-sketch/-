...
KOLOMNA_SOURCES = CitySources(
    ...
    news_rss=[
        # Google News ru RSS — отдаёт федеральные и региональные материалы
        # по запросу «Коломна». Живой публичный фид без ключей.
        # Старый https://news.yandex.ru/Kolomna/index.rss ушёл в Дзен и
        # отвечает таймаутом, поэтому оставлен только для истории.
        Source(
            "news_rss",
            "Google News — Коломна",
